...
def test_atari_vcs_modern_descriptor(blueretro):
    ...
    assert rsp['hid_reports'][1]["usages"][0]["usage_page"] == 0x02
    assert rsp['hid_reports'][1]["usages"][0]["usage"] == 0x00
    assert rsp['hid_reports'][1]["usages"][1]["usage_page"] == 0x02
    assert rsp['hid_reports'][1]["usages"][1]["usage"] == 0x00
    assert rsp['hid_reports'][1]["usages"][2]["usage_page"] == 0x02
    assert rsp['hid_reports'][1]["usages"][2]["usage"] == 0x00
    assert rsp['hid_reports'][1]["usages"][3]["usage_page"] == 0x02
