...
enum {
    ...
    WIRED_WAITING_FOR_RELEASE_MACRO1,
    WIRED_WAITING_FOR_RELEASE_MACRO2,
    WIRED_WAITING_FOR_RELEASE_MACRO3,
    WIRED_WAITING_FOR_RELEASE_MACRO4,
    WIRED_WAITING_FOR_RELEASE_MACRO5,
    WIRED_GPIO_INIT,
    WIRED_KBMON_INIT,
};
