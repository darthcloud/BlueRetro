...
enum {
    JOYSTICK_SERIAL_OUT_BTN_LD_LEFT,
    JOYSTICK_SERIAL_OUT_BTN_LD_RIGHT,
    JOYSTICK_SERIAL_OUT_BTN_LD_DOWN,
    JOYSTICK_SERIAL_OUT_BTN_LD_UP,
    JOYSTICK_SERIAL_OUT_BTN_RB_LEFT,
    JOYSTICK_SERIAL_OUT_BTN_RB_RIGHT,
    JOYSTICK_SERIAL_OUT_BTN_RB_DOWN,
    JOYSTICK_SERIAL_OUT_BTN_RB_UP,
    JOYSTICK_SERIAL_OUT_BTN_MM,
    JOYSTICK_SERIAL_OUT_BTN_MS,
    JOYSTICK_SERIAL_OUT_BTN_MT,
    JOYSTICK_SERIAL_OUT_BTN_LS,
    JOYSTICK_SERIAL_OUT_BTN_LJ,
    JOYSTICK_SERIAL_OUT_BTN_RS,
    JOYSTICK_SERIAL_OUT_BTN_RJ,
};
